...
puts "===================Deobfuscate=============================="
puts "$(#{_0xc360[12]})[#{_0xc360[11]}](function() {"
puts "  var _0xf382x1 = $(#{_0xc360[1]})[#{_0xc360[0]}]();"
puts "  var _0xf382x2 = #{_0xc360[2]};"
puts "  if (_0xf382x1 == #{_0xc360[3]} + _0xf382x2) {"
puts "    if (document[#{_0xc360[7]}][#{_0xc360[6]}][#{_0xc360[5]}](#{_0xc360[4]}) == -1) {"
puts "      document[#{_0xc360[7]}] = document[#{_0xc360[7]}][#{_0xc360[6]}] + #{_0xc360[4]} + _0xf382x1;"
puts "    };"
puts "  } else {"
puts "    $(#{_0xc360[10]})[_#{0xc360[9]}](#{_0xc360[8]});"
puts "  };"
puts "});"
puts "============================================================="

_0xf382x2 = "alk3"
_0xf382x1 = "02l1" + _0xf382x2

print "Password: " + _0xf382x1